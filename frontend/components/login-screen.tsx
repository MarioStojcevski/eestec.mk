        ...
        <>  
            <Center h='100vh' bg ='white'>
                <VStack w={{base: '90%', md: '55%', lg: '40%' }} mb='200'>
                    ...
                    <Box boxShadow='dark-lg' bg='white' border='2px' borderColor='primary' p='6' rounded='lg'>

                        <Image src="/images/eestec-logo.png" maxW='40%' mt='2' mb='10' mx='auto' />

                        <Heading variant={{base: 'h5', md: 'h4'}} color={{base: 'primary', md: 'primary' }}textAlign='left' ml='24.5%' mb='5'>
                            Sign in
                        </Heading>
                        ...
                        <FormControl textAlign='left' ml='25%' mb='5'>
                            ...
                            <Input type='email' w='50%' boxShadow='inner' fontSize={{base: '12px', md: '14px', lg: '16px'}}/>
                        ...
                        <FormControl textAlign='left' ml='25%' mb='10'>
                            ...
                            <Input type='password' w='50%' boxShadow='inner' fontSize={{base: '12px', md: '14px', lg: '16px'}}/>
